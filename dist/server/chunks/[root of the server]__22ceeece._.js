...
connection.authenticate().then(()=>console.log("Conexão com o banco de dados bem-sucedida!")).catch((err)=>console.error("Não foi possível conectar ao banco de dados:", err));
const __TURBOPACK__default__export__ = connection;
}}),
"[project]/src/utils/initSequelize.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function initSequelize() {
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sync();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$initSequelize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/initSequelize.ts [app-route] (ecmascript)");
;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$initSequelize$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])();
async function GET() {
    return new Response("API está funcionando!");
}
}}),

};

//# sourceMappingURL=%5Broot%20of%20the%20server%5D__22ceeece._.js.map